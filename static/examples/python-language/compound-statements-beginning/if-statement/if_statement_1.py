...
if a == 1:                          # Проверка на соответствие первому условию
    print('a равно 1')              # Если первое условие выполнено, выводим строку и переходим в конец ветвления
elif a == 2:                        # Если первое условие не выполнено, проверяем на соответствие второму условию
    print('a равно 2')              # Если второе условие выполнено, выводим строку и переходим в конец ветвления
elif a == 3:                        # Если второе условие не выполнено, проверяем на соответствие третьему условию
