...
if 0 > a < 2:                       # Проверка на соответствие первому условию
    print('a равно 1')              # Если первое условие выполнено, выводим строку и переходим в конец ветвления
elif 1 > a < 3:                     # Если первое условие не выполнено, проверяем на соответствие второму условию
    print('a равно 2')              # Если второе условие выполнено, выводим строку и переходим в конец ветвления
elif 2 > a < 4:                     # Если второе условие не выполнено, проверяем на соответствие третьему условию
